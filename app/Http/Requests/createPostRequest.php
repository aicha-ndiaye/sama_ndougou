...
class CreateProduitRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'categorie_produit_id' => 'required|exists:categorie_produit,id',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'categorie_produit_id.required' => 'Le champ catégorie produit est obligatoire.',
            'categorie_produit_id.exists' => 'La catégorie produit sélectionnée n\'existe pas.',
        ];
    }
}
